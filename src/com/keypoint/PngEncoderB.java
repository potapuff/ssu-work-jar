...
public class PngEncoderB extends PngEncoder {
     ...
     *            Encode the alpha channel? false=no; true=yes
     * @param grayscale
     *            output with grayscale? false=no; true=yes
     * @param whichFilter
     *            0=none, 1=sub, 2=up
     * @param compLevel
     *            0..9
     */
    public PngEncoderB(BufferedImage image, boolean encodeAlpha,
            boolean grayscale, int whichFilter, int compLevel) {
        this.image = image;
    ...
    public static byte[] dumpComponentImage(Component comp) {
        try {
            ...
            PngEncoderB png = new PngEncoderB(img2, PngEncoderB.ENCODE_ALPHA,
                    false, PngEncoderB.FILTER_NONE, 9);
