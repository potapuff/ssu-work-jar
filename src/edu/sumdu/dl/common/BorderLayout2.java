 ...
 *
 *  chnages were made to acces NEWSC compnents
 */
import java.awt.*;
 ...
 * <code>AFTER_LINE_ENDS</code>. These are equivalent to <code>PAGE_START</code>, <code>PAGE_END</code>, <code>LINE_START</code> and <code>LINE_END</code>
 ...
 * <p>
 * <img src="doc-files/BorderLayout-1.gif" ALIGN=center HSPACE=10 VSPACE=7>
 * <p>
 ...
 * @since JDK1.0
 */
public class BorderLayout2 implements LayoutManager2, java.io.Serializable {
    ...
    /**
     * Now it is public since 2003-09-29 meadow Get the component that
     * corresponds to the given constraint location
     * 
     * @param key
     ...
     */
    public Component getChild(String key, boolean ltr) {
